...
prompt_and_store "SUPABASE_URL" "Supabase project URL (server-side only)"
prompt_and_store "SUPABASE_SERVICE_ROLE_KEY" "Supabase service_role key — Settings → API → service_role secret"
prompt_and_store "RAPIDAPI_KEY" "RapidAPI key for JSearch"
